...
### 2. Regional analysis using maps and pie charts to highlight market diversity.

### 3. Dynamic filters for year and region selection to facilitate deeper exploration.

### 4. KPI displays comparing actual sales to yearly targets.
This repository contains source datasets, dashboard screenshots, and analytic scripts (Excel/Power BI/Python as applicable), enabling others to reproduce or extend the analysis.
